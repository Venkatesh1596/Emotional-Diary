...
data = {
    "text": happy_texts + sad_texts + angry_texts + fear_texts + neutral_texts,
    "emotion": (
        ["Happy"] * len(happy_texts) +
        ["Sad"] * len(sad_texts) +
        ["Angry"] * len(angry_texts) +
        ["Fear"] * len(fear_texts) +
...
print("[OK] Advanced Emotion Model trained and saved successfully!")